...
void read_trees_catalogs(tree_info *trees,
  ...
  if(check_mode_for_flag(mode,READ_TREES_CATALOGS_GROUPS)){
     if(check_mode_for_flag(mode,READ_TREES_CATALOGS_SHORT)){
        init_tree_data(trees,(void ***)&short_properties_groups_local,sizeof(halo_info),INIT_TREE_DATA_GROUPS,"short_properties_groups");
        properties_groups_local=NULL;
     }
     else{
        init_tree_data(trees,(void ***)&properties_groups_local,sizeof(halo_properties_info),INIT_TREE_DATA_GROUPS,"properties_groups");
        short_properties_groups_local=NULL;
     }
     if(check_mode_for_flag(mode,READ_TREES_CATALOGS_PROFILES)){
        init_tree_data(trees,(void ***)&profiles_groups_local,sizeof(halo_profile_info),INIT_TREE_DATA_GROUPS,"profiles_groups");
  ...
  if(check_mode_for_flag(mode,READ_TREES_CATALOGS_SUBGROUPS)){
     if(check_mode_for_flag(mode,READ_TREES_CATALOGS_SHORT)){
        init_tree_data(trees,(void ***)&short_properties_subgroups_local,sizeof(halo_info),INIT_TREE_DATA_SUBGROUPS,"short_properties_subgroups");
        properties_subgroups_local=NULL;
     }
     else{
        init_tree_data(trees,(void ***)&properties_subgroups_local,sizeof(halo_properties_info),INIT_TREE_DATA_SUBGROUPS,"properties_subgroups");
        short_properties_subgroups_local=NULL;
     }
     if(check_mode_for_flag(mode,READ_TREES_CATALOGS_PROFILES)){
        init_tree_data(trees,(void ***)&profiles_subgroups_local,sizeof(halo_profile_info),INIT_TREE_DATA_SUBGROUPS,"profiles_subgroups");
        read_catalog_mode=read_catalog_mode|READ_CATALOG_PROFILES;
     }
     else
