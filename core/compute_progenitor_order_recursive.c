...
void compute_progenitor_order_recursive(tree_node_info *descendant,int *score_descendant,int mode){
  ...
  if(descendant->n_progenitors>1){
     ...
     while(current_progenitor!=NULL){
        ...
        compute_progenitor_order_recursive(current_progenitor,&(score[n_halos]),mode); // Make score list
     ...
     compute_progenitor_order_recursive(descendant->progenitor_first,score_descendant,mode);
