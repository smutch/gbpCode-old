...
int main(int argc, char *argv[]){
  ...
  for(;
      i_read<=trees->i_read_stop && i_halo>=0;
    ...
    if(flag_write_header){
       ...
       fprintf(fp_out,"#        (%02d): Halo index\n",                  i_column++);
       fprintf(fp_out,"#        (%02d): Bridge forematch ID\n",         i_column++);
       fprintf(fp_out,"#        (%02d): Bridge forematch file offset\n",i_column++);
       fprintf(fp_out,"#        (%02d): Bridge forematch index\n",      i_column++);
       fprintf(fp_out,"#        (%02d): Bridge backmatch ID\n",         i_column++);
       fprintf(fp_out,"#        (%02d): Bridge backmatch file offset\n",i_column++);
    ...
    fprintf(fp_out,"%d %7d %7d %7d %7d %7d %7d %7d %7d %7d %7d %7d %7d %7d %5.2lf %s\n",
                   i_read,
                   i_halo,
                   halo_id,
                   halo_type,
                   ...
                   halo_index,
                   bridge_forematch_id,
                   trees->snap_list[bridge_forematch_file],
                   bridge_forematch_index,
                   bridge_backmatch_id,
                   trees->snap_list[bridge_backmatch_file],
