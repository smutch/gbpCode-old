...
int main(int argc, char *argv[]){
  ...
  fprintf(fp,"#        (03): max score (0.9*n_particles)\n");
  fprintf(fp,"#        (04): max score (0.8*n_particles)\n");
  fprintf(fp,"#        (05): max score (0.7*n_particles)\n");
  fprintf(fp,"#        (06): max score (0.6*n_particles)\n");
  fprintf(fp,"#        (07): max score (0.5*n_particles)\n");
  fprintf(fp,"#        (08): max score (0.4*n_particles)\n");
  fprintf(fp,"#        (09): max score (0.3*n_particles)\n");
  fprintf(fp,"#        (10): max score (0.2*n_particles)\n");
  fprintf(fp,"#        (11): max score (0.1*n_particles)\n");
  for(double n_particles=20.;n_particles<1e9;n_particles*=1.2){
